      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-5 sm:p-6 shadow-lg space-y-5">
        ...
        <div className="space-y-2.5">
          ...
          <div className="flex flex-wrap items-center justify-between text-xs text-slate-400">
            <span className="flex items-center gap-1.5"><span className="w-2.5 h-2.5 bg-slate-700 rounded-lg inline-block"></span> Trip Burn: {tripFuel} ({fltTime})</span>
            <span className="flex items-center gap-1.5"><span className="w-2.5 h-2.5 bg-slate-800 rounded-lg inline-block"></span> Alternate: {altnFuel} ({altnIcao})</span>
            <span className="flex items-center gap-1.5"><span className="w-2.5 h-2.5 bg-amber-600/70 rounded-lg inline-block"></span> DISC Fuel: {discFuel} (버퍼/기상)</span>
            <span className="flex items-center gap-1.5"><span className="w-2.5 h-2.5 bg-slate-800 rounded-lg inline-block"></span> Final Reserve: {finalRes} (30m)</span>
          </div>
        </div>
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-5 shadow-lg space-y-4">
          ...
          <div className="grid grid-cols-3 gap-2.5 text-center">
            <div className="bg-slate-950/80 p-3 rounded-xl border border-slate-800">
              <span className="text-2xs text-slate-400 block">FIRST</span>
              <span className="text-base font-bold text-slate-200 block mt-1">{payload.pax_first}</span>
            </div>
            <div className="bg-slate-950/80 p-3 rounded-xl border border-slate-800">
              <span className="text-2xs text-slate-400 block">BUSINESS</span>
              <span className="text-base font-bold text-white block mt-1">{payload.pax_business}</span>
            </div>
            <div className="bg-slate-950/80 p-3 rounded-xl border border-slate-800">
              <span className="text-2xs text-slate-400 block">ECONOMY</span>
